    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4">
        {#each playlists as playlist}
            <a
                ...
                class="flex flex-col gap-2 rounded-xl bg-[var(--color-surface)] p-3 shadow-sm transition-shadow hover:bg-[var(--color-violet-pale)] hover:shadow-md md:p-4"
            >
                <div
                    class="flex h-20 items-center justify-center rounded-xl bg-[var(--color-violet-pale)] text-[var(--color-accent)] md:h-24"
                >
...
{#if showCreateModal}
    <div class="fixed inset-0 flex items-center justify-center bg-black/20">
        <form
            ...
            class="flex w-80 flex-col gap-3 rounded-lg bg-[var(--color-surface)] p-6"
        >
