        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <button
                    ...
                    class="rounded-lg border border-gray-300 px-3 py-2 text-sm text-[var(--color-text-muted)] hover:bg-[var(--color-violet-pale)]"
                >
                    {m["add_song"]()}
                </button>
                <button
...
{#if showAddModal}
    <div class="fixed inset-0 flex items-center justify-center bg-black/20">
        <div
            class="flex h-96 w-96 flex-col gap-3 rounded-lg bg-[var(--color-surface)] p-6"
        >
            <div class="flex items-center justify-between">
            ...
            <div class="flex flex-1 flex-col gap-1 overflow-y-auto">
                {#each visibleAddResults as music}
                    <button
                        ...
                        class="flex items-center gap-3 rounded-lg px-2 py-2 text-left hover:bg-[var(--color-violet-pale)]"
                    >
                        <img
